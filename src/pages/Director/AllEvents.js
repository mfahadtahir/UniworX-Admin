...
export default function AllEvents() {
  ...
  const emptyRows = page > 0 ? Math.max(0, (1 + page) * rowsPerPage - event.length) : 0;

  const filteredUsers = applySortFilter(event, getComparator(order, orderBy), filterName);
