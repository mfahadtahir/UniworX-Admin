...
import { NewEventModal } from '../components/_dashboard/events/NewEventModal';
...
export default function Events() {
  ...
  const handleNewEventModal = () => setNewEventModalOpen(!newEventModalOpen);
        ...
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          ...
          JSON.parse(localStorage.getItem('user')).roles <= 40 ? (
            <>
              ...
              <NewEventModal open={newEventModalOpen} handleClose={handleNewEventModal} />
            </>
          ) : null}
        </Stack>
        <Card>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers
                    ...
                    .map((row, key) => {
                      const { image, name, description, startDate, startTime, venue, approved } =
                        row;
